...
export const categories = {
  ...
  CATEGORY_DETAILS_API: BASE_URL + "/course/getCategoryDetails"
}
...
export const courseEndpoints = {
  ...
  UPDATE_SECTION_API: BASE_URL + "/course/editSection",
...
export const reviewAndRatingEndPoints = {
  CREATE_REVIEW_API: BASE_URL + '/course/createRatingAndReviews',
  GET_ALL_REVIEWS_API: BASE_URL + '/course/getAllRatingReview'
