            ...
            >
                ...
                <div className="px-4">
                    ...
                    <div className="flex flex-col gap-4">
                        <button
                            className="bg-yellow-50 text-black font-semibold px-3 py-2 rounded-md "
                            onClick={
                        ...
                        {(!user || !course?.studentEnrolled.includes(user?._id)) && (
                            <button onClick={handleAddToCart} className="bg-richblack-800 px-3 py-2 text-white rounded-md font-semibold">
                                Add to Cart
                            </button>
                        )}
                    </div>
